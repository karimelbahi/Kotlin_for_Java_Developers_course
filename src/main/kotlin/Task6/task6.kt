...
fun List<Int>.allNonZero() =  all { it != 0 }  // all elements are not zero
fun List<Int>.allNonZero1() =  none { it == 0 } // no zero element, no zero is present in the list.
fun List<Int>.allNonZero2() =  !any { it == 0 } // not contains any zero

fun List<Int>.containsZero() =  any { it == 0 }  // one zero element at least
fun List<Int>.containsZero1() =  !all { it != 0 } // not all elements are not zero
fun List<Int>.containsZero2() =  !none { it == 0 }  // not (no zero element*, one zero is present in the list.
